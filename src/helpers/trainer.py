...
from Helpers.utils import NILMmetrics
...
class SeqToSeqTrainer():
    def __init__(self,
                 ...
                 training_in_model=False, loss_in_model=False,
    ...
    def evaluate(self, test_loader, scaler=None, factor_scaling=1, 
                 ...
                 threshold_small_values=0, threshold_activation=None, apply_sigmoid=True):
        """
        ...
        if self.consumption_pred:
            ...
            metrics = self.f_metrics(y=None, y_hat=None, y_state=y_state, y_hat_state=y_state)
